...
namespace KansusGames.KansusAds.Core
{
    ...
    public interface IAdNetwork
    {
        ...
        /// <param name="onInit">Optional initialization callback.</param>
        void Initialize(string appId, bool servePersonalizedAds = true, AdNetworkExtras extras = null, Action<bool> onInit = null);
