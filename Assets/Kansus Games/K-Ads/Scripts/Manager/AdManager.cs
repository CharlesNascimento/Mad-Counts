...
namespace KansusGames.KansusAds.Manager
{
    ...
    public class AdManager : IAdManager
    {
        ...
        public void Initialize(bool servePersonalizedAds = true, AdNetworkExtras extras = null, Action<bool> onInit = null)
        {
            adPlatform.Initialize(settings.AppId, servePersonalizedAds, extras, onInit: (success) =>
            {
        ...
        public void ShowInterstitialAd(Action onClose = null, Action<string> onFail = null, string placementId = null)
        {
            ...
            if (CurrentTimeInSeconds - lastTimePlayed < adSettings.TimeCap)
            {
                ...
                onFail?.Invoke("Interstitial ad will not play due to its time cap");
                return;
            }
